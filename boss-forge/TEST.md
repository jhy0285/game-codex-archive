...
- Interactive in-app-browser agent QA selected two rites, awakened the Bell-Smith, issued movement/shroud/pointer-strike input, observed the defeat/return presentation, and found no console error. This is not a human playtest.
- No source or mechanics change was required; no deployment was attempted.
