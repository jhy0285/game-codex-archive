...
const ENGLISH = {
  ...
  chapterThreeObjective: 'Record yourself throwing the same memory core your past self will throw back to you.',
  ...
  objectiveAtriumCatch: 'Past self throws the same core back to you.',
  objectiveAtriumRedirect: 'Your past self throws the core you receive.',
...
const KOREAN = {
  ...
  chapterThreeObjective: '과거의 내가 던질 동일한 메모리 코어를 미리 던져 두세요.',
  ...
  objectiveAtriumCatch: '과거의 내가 같은 코어를 다시 던집니다.',
  objectiveAtriumRedirect: '과거의 내가 던진 코어를 받습니다.',
