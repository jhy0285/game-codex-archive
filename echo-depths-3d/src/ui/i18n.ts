...
const ENGLISH = {
  ...
  chapterFourObjective: "Find the watcher's blind side and open the way.",
  chapterFourComplete: 'The watcher followed a memory into the dark.',
  chapterFiveName: 'THE PARADOX WELL',
  chapterFiveObjective: 'Recover the Core and release the final passage.',
  ...
  objectiveWatcherHazard: 'Use the gallery to neutralize the watcher.',
  objectiveParadoxCore: 'Restore power to the well.',
  objectiveParadoxGuardian: 'Open a vulnerable angle on the guardian.',
  objectiveParadoxSync: 'Release the final passage.',
...
const KOREAN = {
  ...
  chapterFourObjective: '감시자의 사각을 찾아 길을 여세요.',
  chapterFourComplete: '감시자는 기억을 따라 어둠 속으로 사라졌습니다.',
  chapterFiveName: '역설의 우물',
  chapterFiveObjective: 'Core를 되찾아 마지막 통로를 해제하세요.',
  ...
  objectiveWatcherHazard: '회랑을 이용해 감시자를 무력화하세요.',
  objectiveParadoxCore: '우물 동력을 복구하세요.',
  objectiveParadoxGuardian: '수호자의 빈틈을 만드세요.',
  objectiveParadoxSync: '마지막 통로를 해제하세요.',
