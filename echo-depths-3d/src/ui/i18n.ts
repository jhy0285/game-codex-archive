...
const ENGLISH = {
  ...
  chapterThreeObjective: 'Catch the same Core your past self throws, then deliver it to the receiver.',
  ...
  objectiveAtriumBridge: 'Past self picks up the same core.',
  objectiveAtriumCatch: 'Catch the same Core your past self throws.',
  objectiveAtriumRedirect: 'Carry the received Core to the receiver.',
  ...
  feedbackTransferLaneOpen: 'Transfer shutter opened. The east catch lane is clear.',
...
const KOREAN = {
  ...
  chapterThreeObjective: '과거의 내가 던진 동일한 Core를 받아 수신기에 전달하세요.',
  ...
  objectiveAtriumBridge: '과거의 내가 같은 코어를 집어 듭니다.',
  objectiveAtriumCatch: '과거의 내가 던진 동일한 Core 받기',
  objectiveAtriumRedirect: '받은 Core를 수신기에 전달하기',
  ...
  feedbackTransferLaneOpen: '전송 셔터가 열렸습니다. 동쪽 수거 통로가 확보되었습니다.',
