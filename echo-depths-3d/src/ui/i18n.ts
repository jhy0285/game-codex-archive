...
const ENGLISH = {
  ...
  chapterThreeObjective: 'Send the core between floors, turn the bridge, and redirect the throw into its receiver.',
  chapterThreeComplete: 'The core crossed the space between two moments.',
  chapterFourName: "THE WATCHER'S GALLERY",
  chapterFourObjective: 'Use cover and your echo to lure the watcher, then strike it from height into the trap.',
  chapterFourComplete: 'The watcher followed a memory into the dark.',
  chapterFiveName: 'THE PARADOX WELL',
  chapterFiveObjective: 'Split the guardian, machinery, and final synchronizers between present and echo before time closes.',
  ...
  objectiveAtriumBridge: 'Keep the rotating bridge aligned.',
  objectiveAtriumCatch: 'Catch the core thrown from below.',
  objectiveAtriumRedirect: 'Redirect the core into the upper receiver.',
  objectiveWatcherLure: 'Draw the watcher toward the echo.',
  objectiveWatcherHazard: 'Strike the watcher from height into the trap.',
  objectiveParadoxCore: 'Charge the upper receiver.',
  objectiveParadoxGuardian: 'Expose and break the guardian rear seal from above.',
  objectiveParadoxSync: 'Activate the lower and upper synchronizers together.',
  ...
  feedbackRecordEnd: 'Room rewound. Echo released.',
  ...
  feedbackCoreCaught: 'Core caught.',
  feedbackCoreRedirected: 'Trajectory redirected.',
  feedbackWatcherLured: 'Watcher attention transferred to the echo.',
  feedbackGuardianOpen: 'Guardian shield exposed.',
  feedbackGuardianShield: 'The guardian shield faces you. Let the echo draw its attention, then strike from above.',
  feedbackEscapeOpen: 'Final passage open. Run.',
  failureFall: 'The Depths reclaimed you. The chapter has rewound.',
  ...
  failureDefeat: 'Your present form broke. The chapter has rewound.',
...
const KOREAN = {
  ...
  controlsEcho:
    'R로 기록을 시작하고 다시 R을 누르세요. 방이 되감긴 뒤 고정 스텝 입력과 행동을 그대로 재생하는 에코 하나가 나타납니다.',
  ...
  chapterThreeObjective: '층 사이로 코어를 보내고 회전 다리를 움직여 공격으로 궤적을 수신기에 맞추세요.',
  chapterThreeComplete: '코어가 두 시간 사이의 공간을 건넜습니다.',
  chapterFourName: '감시자의 회랑',
  chapterFourObjective: '엄폐물과 에코로 감시자를 유인한 뒤 높은 곳에서 공격해 함정으로 밀어내세요.',
  chapterFourComplete: '감시자는 기억을 따라 어둠 속으로 사라졌습니다.',
  chapterFiveName: '역설의 우물',
  chapterFiveObjective: '시간이 닫히기 전에 수호자와 장치, 최종 동기화기를 현재와 에코가 나누어 해결하세요.',
  ...
  objectiveAtriumBridge: '회전 다리가 정렬된 상태를 유지하세요.',
  objectiveAtriumCatch: '아래층에서 던진 코어를 받으세요.',
  objectiveAtriumRedirect: '코어를 공격해 위층 수신기로 보내세요.',
  objectiveWatcherLure: '감시자를 에코 쪽으로 유인하세요.',
  objectiveWatcherHazard: '높은 곳에서 감시자를 공격해 함정으로 밀어내세요.',
  objectiveParadoxCore: '위층 수신기를 충전하세요.',
  objectiveParadoxGuardian: '위에서 수호자의 후면 봉인을 노출하고 파괴하세요.',
  objectiveParadoxSync: '아래층과 위층 동기화기를 동시에 작동하세요.',
  ...
  feedbackRecordEnd: '방을 되감았습니다. 에코가 재생됩니다.',
  ...
  feedbackCoreCaught: '코어를 받았습니다.',
  feedbackCoreRedirected: '코어 궤적을 바꿨습니다.',
  feedbackWatcherLured: '감시자의 주의가 에코로 향했습니다.',
  feedbackGuardianOpen: '수호자의 방패가 열렸습니다.',
  feedbackGuardianShield: '수호자의 방패가 당신을 향하고 있습니다. 에코로 시선을 돌린 뒤 위에서 공격하세요.',
  feedbackEscapeOpen: '마지막 통로가 열렸습니다. 달리세요.',
  failureFall: '심층 구역으로 추락했습니다. 챕터를 되감습니다.',
  ...
  failureDefeat: '현재의 형체가 무너졌습니다. 챕터를 되감습니다.',
