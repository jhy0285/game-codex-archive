...
const ENGLISH = {
  ...
  chapterFourObjective: 'Let the Echo ring the bell, then knock the pursuing Watcher into the spikes from the high rear flank.',
  ...
  objectiveWatcherHazard: 'Use cover, climb the ramp, and knock the Watcher into the spikes from the high rear flank.',
  objectiveParadoxCore: 'Avoid the raised Guardian arena. Record once: throw the same Core east, continue to the lower seal, then power the platform.',
  ...
  feedbackGuardianOpen: 'Platform powered. The Echo on the lower seal exposes the Guardian\'s rear mark.',
  ...
  failureSeen: 'The Watcher caught your present form. Use cover to break the pursuit.',
...
const KOREAN = {
  ...
  chapterFourObjective: 'Echo가 종을 울려 감시자를 가시 함정 앞으로 유인한 뒤, 높은 후방에서 밀어 넣으세요.',
  ...
  objectiveWatcherHazard: '엄폐와 경사로를 이용해 높은 후방에서 감시자를 가시 함정으로 밀어 넣으세요.',
  objectiveParadoxCore: '높은 수호자 단상을 피하세요. 한 번 기록해 동일한 Core를 동쪽으로 던지고 아래 봉인까지 간 뒤 플랫폼을 작동시키세요.',
  ...
  feedbackGuardianOpen: '플랫폼이 켜졌습니다. 아래 봉인의 Echo가 수호자의 후면 표식을 노출합니다.',
  ...
  failureSeen: '감시자가 현재의 당신을 붙잡았습니다. 엄폐로 추격 경로를 끊으세요.',
