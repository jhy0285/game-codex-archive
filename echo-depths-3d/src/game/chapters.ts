...
export const CHAPTERS: readonly ChapterDefinition[] = [
  ...
  },
  {
    ...
    echoMaxTicks: 18 * 60,
    escapeTimeTicks: null,
    playerSpawn: v(-6.1, 3.58, 3.3),
    exitCenter: v(10.2, 1.08, -0.4),
    // OBJECT TRANSFER: past self throws the SAME real Memory Core to present self
    mechanics: ['move', 'echo', 'carry', 'throw', 'height'],
    plates: [],
    levers: [],
    doorIds: ['atrium-door'],
    elevatorIds: [],
  ...
  },
  {
    ...
    echoMaxTicks: 18 * 60,
    escapeTimeTicks: null,
    playerSpawn: v(-7.2, 1.08, 3.8),
    exitCenter: v(8.35, 1.08, -1.8),
  ...
  },
  {
    ...
    playerSpawn: v(-7.5, 1.08, 3.8),
    exitCenter: v(8.85, 5.78, 0.3),
    mechanics: [
      'echo',
      'carry',
      'throw',
