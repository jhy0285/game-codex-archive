...
export const CHAPTERS: readonly ChapterDefinition[] = [
  ...
  },
  {
    ...
    mechanics: ['echo', 'throw', 'catch', 'redirect', 'rotating-bridge', 'height'],
    plates: [],
    levers: [{ id: 'bridge-lever', mode: 'momentary' }],
    doorIds: ['atrium-door'],
    elevatorIds: [],
    platformIds: [],
    bridgeIds: ['rotating-bridge'],
    trapIds: [],
    crates: [],
    cores: [{ id: 'memory-core', spawn: v(-3.8, 3.75, 2.5) }],
    enemies: [],
    objectives: [
      {
        id: 'catch-core',
        labelKey: 'objective.atrium.catch',
        requiredFacts: [ObjectiveFacts.CoreCaughtByPlayer],
      },
      {
        id: 'redirect-core',
      ...
      {
        id: 'rotate-bridge',
        labelKey: 'objective.atrium.bridge',
        requiredFacts: [
